        ...
        <div class="lakum-header__container">
            ...
            <nav class="lakum-nav">
                <ul class="lakum-nav__list">
                    ...
                    <li class="lakum-nav__item"><a href="spaces.php" class="lakum-nav__link <?php echo (basename($_SERVER['PHP_SELF']) === 'spaces.php') ? 'lakum-nav__link--active' : ''; ?>"><?php echo t('spaces', 'Spaces'); ?></a></li>
                    <li class="lakum-nav__item"><a href="exhibitions.php" class="lakum-nav__link <?php echo (basename($_SERVER['PHP_SELF']) === 'exhibitions.php') ? 'lakum-nav__link--active' : ''; ?>"><?php echo t('exhibitions', 'Exhibitions'); ?></a></li>
                    <li class="lakum-nav__item"><a href="calendar.php" class="lakum-nav__link <?php echo (basename($_SERVER['PHP_SELF']) === 'calendar.php') ? 'lakum-nav__link--active' : ''; ?>"><?php echo t('calendar', 'Calendar'); ?></a></li>
