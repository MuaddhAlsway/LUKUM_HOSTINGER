...
<head>
    ...
    <!-- Preload LCP image (contact hero) - Mobile-first -->
        ...
        <div class="lakum-header__container">
            ...
            <nav class="lakum-nav">
                <ul class="lakum-nav__list">
                    ...
                    <li class="lakum-nav__item"><a href="contact.php" class="lakum-nav__link lakum-nav__link--active"><?php echo t('contact_us', 'Contact'); ?></a></li>
