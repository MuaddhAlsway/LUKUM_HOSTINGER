...
try {
    ...
    $pricingData = [
        [
            ...
            'description_ar' => 'معرض فسيح مثالي للتثبيتات واسعة النطاق أو الاستقبالات',
            'currency_image' => 'RS/OIP.webp',
        ...
        [
            ...
            'vat_note' => '*(excluding VAT)',
            'vat_note_ar' => '*(غير شامل الضريبة)',
            'description_en' => 'Perfectly suited for intimate showcases, creative workshops, and panel discussions',
            'description_ar' => 'مناسبة تماماً للعروض الحميمية والورش الإبداعية والنقاشات',
            'currency_image' => 'RS/OIP.webp',
        ...
        [
            ...
            'vat_note' => '*(excluding VAT)',
            'vat_note_ar' => '*(غير شامل الضريبة)',
            'description_en' => 'Short-format experiences and workshops',
            'description_ar' => 'تجارب وورش عمل قصيرة الأجل',
            'currency_image' => 'RS/OIP.webp',
        ...
        [
            ...
            'vat_note' => '*(excluding VAT)',
            'vat_note_ar' => '*(غير شامل الضريبة)',
            'description_en' => 'Dedicated day for setup or dismantling',
            'description_ar' => 'يوم مخصص للإعداد أو الفك',
            'currency_image' => 'RS/OIP.webp',
        ...
        [
            ...
            'vat_note' => '*(excluding VAT)',
            'vat_note_ar' => '*(غير شامل الضريبة)',
            'description_en' => 'Exclusive café rental with full space booking',
            'description_ar' => 'استئجار المقهى الحصري مع حجز المساحة الكاملة',
            'currency_image' => 'RS/OIP.webp',
        ...
        [
            ...
            'vat_note' => '*(excluding VAT)',
            'vat_note_ar' => '*(غير شامل الضريبة)',
            'description_en' => 'Professional meeting space with refreshments and technology',
            'description_ar' => 'مساحة اجتماعات احترافية مع المرطبات والتكنولوجيا',
            'currency_image' => 'RS/OIP.webp',
    ...
    foreach ($pricingData as $item) {
        $query = "INSERT INTO pricing (id, title, name_en, name_ar, price, price_unit, price_unit_ar, price_sec, vat_note, vat_note_ar, description_en, description_ar, currency_image, content, display_order, is_active) 
                  VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        $stmt->bind_param('isssisssssssssii', 
            $item['id'],
            $item['title'],
            $item['name_en'],
            $item['name_ar'],
