...
try {
    ...
    if (!$db->query($deleteQuery)) {
        throw new Exception('Delete failed: ' . $db->getConnection()->error);
    }
    
    // Step 2: Insert real Spaces Pricing data
    $pricingData = [
        [
            'title' => 'Hall 1',
            'price' => 12000,
    ...
    echo json_encode([
        'success' => true,
        'message' => "Deleted all pricing and synced $inserted real pricing items",
        'deleted' => true,
        'inserted' => $inserted
    ]);
