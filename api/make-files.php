...
try {
    ...
    echo "<li>Update event.php - Add: \$slug = basename(__FILE__, '.php');</li>";
    echo "<li>Update blogPageDetails.php - Add: \$slug = basename(__FILE__, '.php');</li>";
    echo "<li>Update pressPageDetails.php - Add: \$slug = basename(__FILE__, '.php');</li>";
    echo "<li>Update frontend URLs in blog.php, event.php, press.php</li>";
