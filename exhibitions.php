...
<body class="<?php echo getLanguageClass(); ?>">
    ...
    <script>
        ...
        // FAB and menu functionality
        document.getElementById('fabTrigger')?.addEventListener('click', (e) => {
            e.preventDefault();
            document.getElementById('lakumContactFab').classList.toggle('lakum-contact-fab--active');
        });

        document.querySelector('.lakum-header__mobile-toggle')?.addEventListener('click', function() {
            this.classList.toggle('lakum-header__mobile-toggle--active');
            document.querySelector('.lakum-nav').classList.toggle('lakum-nav--active');
        });
    </script>
