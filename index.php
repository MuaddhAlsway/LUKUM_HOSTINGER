...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0;  }
        ...
        .lakum-hero { position: relative; width: 100%; height: 85vh; min-height: 600px; display: flex; align-items: center; justify-content: center; background: #1a1a1a; z-index: 1; }
        .lakum-hero__image-wrapper { position: absolute; inset: 0; z-index: 0; overflow: hidden; }
        .lakum-hero__image { width: 100%; height: 100%; object-fit: cover; display: block; }
        .lakum-hero__overlay { position: absolute; inset: 0; background: linear-gradient(to bottom, rgba(0, 0, 0, 0.5) 0%, rgba(0, 0, 0, 0.65) 100%); z-index: 1; }
        .lakum-hero__content { position: relative; z-index: 2; text-align: center; color: #fff; max-width: 1400px; width: 90%; padding: 0 20px; }
        .lakum-hero__title { 
