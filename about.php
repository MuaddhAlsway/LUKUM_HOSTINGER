...
<section class="lakum-tagline-section"><div class="lakum-container"><p class="lakum-tagline-section__spaces"><?php echo t('tagline_spaces', 'Artspace, Gallery, Hub, Library, Shop, Cafï¿½'); ?></p><h2 class="lakum-tagline-section__title"><?php echo t('tagline_main', 'Where Encounters Shape Culture'); ?></h2></div></section>
